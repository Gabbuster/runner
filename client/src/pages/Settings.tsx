        ...
        <div className="bg-card border border-border rounded-2xl divide-y divide-border/50">
           <div className="p-4 flex items-center justify-between">
              ...
              <button 
                ...
                className={`w-12 h-6 rounded-full p-1 transition-colors ${audioEnabled ? 'bg-primary' : 'bg-secondary'}`}
              >
                <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${audioEnabled ? 'translate-x-6' : 'translate-x-0'}`} />
              </button>
           </div>
           ...
           <div className="p-4 flex items-center justify-between opacity-50 pointer-events-none">
              ...
              <span className="text-xs font-bold text-muted-foreground uppercase">Always On</span>
           </div>
        </div>
